...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "prv_kite_aux_attack", FleetMemberType.SHIP, "prv Att arbeta sig uppåt", false);
		...
		api.addToFleet(FleetSide.ENEMY, "prv_dominator_rb_assault",FleetMemberType.SHIP,"Duty and Vocation", false);
		...
		api.addToFleet(FleetSide.ENEMY, "prv_gnejs_p_ambush", FleetMemberType.SHIP, "1st samurai", false);
		api.addToFleet(FleetSide.ENEMY, "prv_skara_attack", FleetMemberType.SHIP, "nightshift", false);
		api.addToFleet(FleetSide.ENEMY, "prv_basalt_raider", FleetMemberType.SHIP, "what we can gain", false);
		api.addToFleet(FleetSide.ENEMY, "prv_visent_raider", FleetMemberType.SHIP, "Unto a better wharf", false);

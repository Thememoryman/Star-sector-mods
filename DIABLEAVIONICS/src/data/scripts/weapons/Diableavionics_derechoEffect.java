    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (theSystem.isOn()){
            ...
            if (timer.intervalElapsed()){
                List <MissileAPI> missiles=AIUtils.getNearbyEnemyMissiles(theShip, RANGE*theSystem.getEffectLevel());
            ...
            if(rim>RIMTICK){
                ...
                */
                MagicRender.objectspace(
                                        ...
                                        new Vector2f(),
                                        theShip.getVelocity(),
                                        (Vector2f) new Vector2f(1160,4000).scale(theSystem.getEffectLevel()),

...
public class Diableavionics_valiantEffect implements EveryFrameWeaponEffectPlugin
{
    ...
    public static final String headgunID = "HEAD"; 
    public static final String leftgunID = "LEFTGUN"; 
    public static final String rightgunID = "RIGHTGUN"; 
    public static final String leftshoulderID = "TRANSFORM_00"; 
    public static final String rightshoulderID = "TRANSFORM_01"; 
    public static final String leftbarrelID = "TRANSFORM_02"; 
    public static final String rightbarrelID = "TRANSFORM_03"; 
    public static final String backID = "TRANSFORM_04"; 
    public static final String chestID = "TRANSFORM_05"; 
    public static final String headID = "TRANSFORM_06"; 
    public static final String leftpauldronID = "TRANSFORM_07"; 
    public static final String rightpauldronID = "TRANSFORM_08"; 
    public static final String leftcoverID = "TRANSFORM_09"; 
    public static final String rightcoverID = "TRANSFORM_10"; 

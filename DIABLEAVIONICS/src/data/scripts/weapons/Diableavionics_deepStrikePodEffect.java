...
public class Diableavionics_deepStrikePodEffect implements EveryFrameWeaponEffectPlugin {    
    ...
    private boolean dead=false, runOnce=false, hold=true;
    private IntervalUtil checkEnemies = new IntervalUtil (1,2);
...
//        }
        ...
        if(checkEnemies.intervalElapsed()){
            hold = (AIUtils.getNearestEnemy(weapon.getShip())!=null && MathUtils.isWithinRange(weapon.getLocation(), AIUtils.getNearestEnemy(weapon.getShip()).getLocation(),2000));
        }

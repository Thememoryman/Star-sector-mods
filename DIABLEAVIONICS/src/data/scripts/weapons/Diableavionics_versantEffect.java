...
public class Diableavionics_versantEffect implements EveryFrameWeaponEffectPlugin {
    ...
    public static final String leftshieldID = "ENGINE_PANEL_LEFT"; 
    public static final String rightshieldID = "ENGINE_PANEL_RIGHT"; 
    public static final String leftslotID = "GUN_LEFT"; 
    public static final String rightslotID = "GUN_RIGHT"; 
    public static final String leftbarrelID = "BARREL_LEFT"; 
    public static final String rightbarrelID = "BARREL_RIGHT"; 
    public static final String leftdoorID = "SHIELD_LEFT"; 
    public static final String rightdoorID = "SHIELD_RIGHT"; 
    public static final String leftbitID = "COVER_LEFT"; 
    public static final String rightbitID = "COVER_RIGHT"; 
    public static final String leftpanelID = "TOP_LEFT"; 
    public static final String rightpanelID = "TOP_RIGHT"; 

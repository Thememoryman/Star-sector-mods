...
public class LTAMagicVectorThruster implements EveryFrameWeaponEffectPlugin {
    ...
    private Vector2f size= new Vector2f(32,175); //8, 74 were originals
...
//                );
    ...
    private void thrust(WeaponAPI weapon, float angle, float thrust, float smooth){
        ...
        float width=length*size.x/2f+size.x/2f;

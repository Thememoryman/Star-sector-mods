...
public class LTA_TalonRail extends BaseEveryFrameCombatPlugin {
    ...
    private static final String LTA_TalonShipID = "LTA_Talon_Railfed_Interceptor_Wing";
    private static final String LTA_TalonProjectileID = "LTA_talon_lrm";

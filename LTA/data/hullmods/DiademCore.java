...
public class DiademCore extends BaseHullMod {
	...
	public static float AUTOFIRE_AIM = 2f;
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		stats.getNonBeamPDWeaponRangeBonus().modifyFlat(id, RANGE_BONUS);
		stats.getBeamPDWeaponRangeBonus().modifyFlat(id, RANGE_BONUS);

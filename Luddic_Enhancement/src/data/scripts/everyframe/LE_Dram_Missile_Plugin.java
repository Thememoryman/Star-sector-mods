...
public class LE_Dram_Missile_Plugin extends BaseEveryFrameCombatPlugin {
    ...
    private static final Color MIGHT_COLOR_1 = new Color(255, 200, 150);
    ...
    private static final Color MIGHT_COLOR_4 = new Color(255, 225, 75);
    private static final Color MIGHT_COLOR_5 = new Color(255, 175, 50);
    private static final Color MIGHT_COLOR_6 = new Color(255, 150, 0);
    private static final Color MIGHT_COLOR_7 = new Color(200, 100, 0);
    ...
    public static final float EXPANSION_BLAST_DPS = 6000f;
    ...
    public static final float INITIAL_BLAST_RADIUS = 500f;
...
//               10f * attenuate, 40f * attenuate, 1f, MIGHT_COLOR_1, MIGHT_COLOR_2);
        ...
        engine.spawnExplosion(loc, new Vector2f(),
                MIGHT_COLOR_4, 1500f * attenuate, 7.5f * (float) Math.sqrt(attenuate));
        engine.spawnExplosion(loc, new Vector2f(),
                MIGHT_COLOR_1, 2000f * attenuate, 10f * (float) Math.sqrt(attenuate));
        engine.spawnExplosion(loc, new Vector2f(),
                MIGHT_COLOR_5, 2500f * attenuate, 12.5f * (float) Math.sqrt(attenuate));
        engine.spawnExplosion(loc, new Vector2f(),
                MIGHT_COLOR_6, 3500f * attenuate, 15f * (float) Math.sqrt(attenuate));
        engine.spawnExplosion(loc, new Vector2f(),
                MIGHT_COLOR_7, 4500f * attenuate, 20f * (float) Math.sqrt(attenuate));

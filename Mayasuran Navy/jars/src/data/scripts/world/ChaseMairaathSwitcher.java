    ...
    public void advance(float amount) {
        if (!done) {
            ...
            if (!setRep) {
                ...
                // friends
                mayasura.setRelationship("persean_league", 1f);         // always together, friends 'til forever
            ...
            if (market != null && !market.isPlanetConditionMarketOnly() && !market.isPlayerOwned()) {
				...
				if (MN_modPlugin.isExerelin && MAYASURA.equals(PlayerFactionStore.getPlayerFactionIdNGC())) {

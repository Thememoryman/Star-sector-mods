...
import data.scripts.themes.SectorThemeGeneratorMod;
import data.scripts.themes.ThemeGenContextMod;
import com.fs.starfarer.api.impl.campaign.terrain.HyperspaceTerrainPlugin;
import com.fs.starfarer.api.util.Misc;
import com.fs.starfarer.api.util.Pair;
import com.fs.starfarer.api.util.WeightedRandomPicker;

public class SectorProcGenMod implements SectorProcGenPlugin {
    
    public static final float CELL_SIZE = Global.getSettings().getFloat("AdjustedSectorConstellationSize");
    public static final int CONSTELLATION_CELLS = (int)Global.getSettings().getFloat("AdjustedSectorConstellationCellSize");
...
//      MarkovNames.load(names, 3);
    ...
    public void generate(CharacterCreationData data, SectorGenProgress progress) {
        ...
        int count = (int)Global.getSettings().getFloat("AdjustedSectorConstellationCount");
...
//              }
        ...
        // Value from settings, default 20
        float numArcsRndGS = Global.getSettings().getFloat("AdjustedSectorRndArcs");

        int numArcs = (int) (numArcsRndGS + 8f * random.nextFloat());
        ...
        ThemeGenContextMod context = new ThemeGenContextMod();
        context.constellations = constellations;
        SectorThemeGeneratorMod.generate(context);

...
public class SectorGenMod implements SectorGeneratorPlugin {

	boolean HyperStormGen = Global.getSettings().getBoolean("AdjustedSectorHS");
	...
	public void generate(SectorAPI sector) {
		...
		if( HyperStormGen ) {
			...
			SectorEntityToken deep_hyperspace = Misc.addNebulaFromPNG("data/campaign/terrain/no_storms.png",
					0, 0, // center of nebula
					Global.getSector().getHyperspace(), // location to add to
					"terrain", "deep_hyperspace", // "nebula_blue", // texture to use, uses xxx_map for map
					4, 4, Terrain.HYPERSPACE, null); // number of cells in texture
		...
		float minRadius = plugin.getTileSize() * 3f;
